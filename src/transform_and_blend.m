...
% Base Value
    ...
    marked = insertMarker(pic1, projectingXY, 'o', 'color', 'white', 'size', 50);
    imshow(marked);
    ...
    for channel = 1 : 3
        for width = 1 : round(targetImageWidth)
            for height = 1 : round(targetImageHeight)
                ...
                projectedPixelLocation = projectedPixelLocation / projectedPixelLocation(3,1);
