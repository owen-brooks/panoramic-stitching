function kp_used = ransac(kps1, kps2, N)
    ...
    for i = 1:N
        ...
        pic2_upperLeft = [kps2(temp_idxs,:)' ; ones(1, 4)];projectingUL = H * pic2_upperLeft;
        
        score = 0; % score is sum of euclidean dists
        for ii=1:4
            temp_kps2 = [projectingUL(1) projectingUL(2)]./projectingUL(3);
            temp_kps1 = kps1(temp_idxs,:);temp_kps1 = temp_kps1(ii,:);
